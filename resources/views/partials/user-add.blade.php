            ...
            <form class="space-y-7" method="POST">
                <div class="flex space-x-2">
                    <div class="w-1/3">
                        ...
                        <input type="text" name="ppr" id="ppr" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2" placeholder="Ex : 123455" required>
                    </div>
                    <div class="w-1/3">
                        <label for="nom" class="block mb-1 text-sm font-medium text-gray-900">Nom :</label>
                        <input type="text" name="nom" id="nom" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2" placeholder="Ex : Erickson" required>
                    </div>
                    <div class="w-1/3">
                        <label for="prenom" class="block mb-1 text-sm font-medium text-gray-900">Prenom :</label>
                        <input type="text" name="prenom" id="prenom" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2" placeholder="Ex : Emelia" required>
                    </div>
                </div>
                <div>
                ...
                <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Créer Utilisateur</button>
